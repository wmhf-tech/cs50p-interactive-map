...
import {
  aula8QuizModule, // Importa o módulo específico da Aula 8
...
const Aula8QuizContainer: React.FC = () => {
  const moduleId = aula8QuizModule.moduleId;
  ...
  const startNewQuizAttempt = useCallback(() => {
    const selectedQuestions = selectUniqueQuizQuestions(aula8QuizModule, userProgress, 5);
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      {!showQuiz ? (
        <div className="space-y-6 w-full max-w-md">
          <QuizModuleProgress quizModule={aula8QuizModule} userProgress={userProgress} />
...
export default Aula8QuizContainer;
