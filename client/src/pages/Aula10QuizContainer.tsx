...
import {
  aula10QuizModule, // Importa o módulo específico da Aula 10
...
const Aula10QuizContainer: React.FC = () => {
  const moduleId = aula10QuizModule.moduleId;
  ...
  const startNewQuizAttempt = useCallback(() => {
    const selectedQuestions = selectUniqueQuizQuestions(aula10QuizModule, userProgress, 5);
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      {!showQuiz ? (
        <div className="space-y-6 w-full max-w-md">
          <QuizModuleProgress quizModule={aula10QuizModule} userProgress={userProgress} />
...
export default Aula10QuizContainer;
